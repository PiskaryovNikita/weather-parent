 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "com.nixsolutions.wsSoap.user", wsdlLocation = "http://192.168.1.107:8080/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("com.nixsolutions.wsSoap.user", "UserService");
    ...
    public UserSoap getUserSoapImplPort() {
        return super.getPort(new QName("com.nixsolutions.wsSoap.user", "UserSoapImplPort"), UserSoap.class);
    }
    ...
    public UserSoap getUserSoapImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("com.nixsolutions.wsSoap.user", "UserSoapImplPort"), UserSoap.class, features);
    }
