...
public class User {
	...
	//изменение дочерней сущности, перед операцией с родительской
	...
	public User(String login, String password, String email, String fN,
			String lN, Date birthday, Role role) {
		this.login = login;
	...
	public User(Long userId, String login, String password, String email,
			String fN, String lN, Date birthday, Role role) {
		this.userId = userId;
		this.login = login;
		this.password = password;
		this.email = email;
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		// если об.и !null берём его хшкод
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		return (userId == user.userId
				|| (user.userId != null && userId.equals(user.userId)))
				&& (login == user.login
