...
<body>
	...
	<form action="/adminAdd" method="post">
		...
		Password again:<br> <input type="password" id="passch"
			onchange="checkPass()"><br> <b style="color: red"
			...
			type="text" name="birthday" value="YYYY-MM-DD"><br>
		Role:<br> <select name="role">
			<option value="User">User</option>
			<option value="Admin">Admin</option>
		</select><br> <br> <input type="submit" value="OK">
		<button
			onclick="window.location.href = 'https://localhost:8080/home';">Cancel</button>
	</form>
</body>
</html>