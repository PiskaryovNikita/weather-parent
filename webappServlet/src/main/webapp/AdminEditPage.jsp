<%@page import="com.nixsolutions.webapp.modelClasses.User"%>
...
<body>
	...
	<h1 style="text-align: center; margin-top: 10%">Edit user</h1>
	<form action="/adminEdit" method="post">
		Login:<br> <input type="text" name="login" value="<%=request.getParameter("login")%>" readonly><br>
		Password:<br> <input type="password" name="password" id="pass"><br>
		Password again:<br> <input type="password" id="passch" onchange="checkPass()"><br> 
			<b style="color: red" id="info"></b><br> Email:<br> <input type="text"
			...
			type="text" name="birthday" value="YYYY-MM-DD"><br> Role:<br> <select
			name="role">
